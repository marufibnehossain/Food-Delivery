...
const LoginPopup = ({setShowLogin}) => {
  ...
  return (
    <div className='login-popup absolute z-[100] w-full h-full bg-black bg-opacity-40 grid'>
      <form className="login-popup-container place-self-center w-[max(23vw,330px)] text-[#808080] bg-white flex flex-col py-6 px-[30px] rounded-lg text-sm animate-[fadeIn_0.5s_ease-in-out] gap-8">
